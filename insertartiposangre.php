...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Tipo de Sangre</title></head>
    <body>
	...
	<div align="center">
	<form action="insertartiposangre.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Tipo Sangre:
	<td><input type="text" align="LEFT" name="id_ts" /></tr>
	<tr><td><font color=blue size=4>Tipo Sangre:
	<td><input type="text" align="LEFT" name="nom_ts" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO tipo_sangre(ID_TS,NOM_TS) "."VALUES ('$id_ts','$nom_ts')";
