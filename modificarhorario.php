...
?>
    <html>
    <head><title>Modificar Horario</title></head>
    <body>
...
<th><font color=blue size=5>ID_Horario</th>
<th><font color=blue size=5>Horario</th>
...
while ($row=mysql_fetch_array($resultado)){
	echo "<tr><td align=center>".$row['ID_HR']."</td>";
	echo "<td align=center>".$row['NOM_HR']."</td>";
echo "<td align=center><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['ID_HR'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
if (isset ($cambiar)){
	...
	$sql = "SELECT * FROM ".$tabla." WHERE ID_HR=".$cambiar;
	//echo "sql=".$sql;
	...
	<p><font color=blue size=5>ID_Horario:
	<input type="hidden" align="LEFT" name="id_hr" value="<?php echo $registro['ID_HR'];?>" /><p>
	<p><font color=blue size=5>Horario:
	<input type="text" align="LEFT" name="nom_hr" value="<?php echo $registro['NOM_HR'];?>"/><p>
