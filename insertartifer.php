...
<h1><font color=red size=6 face="Courier"><div align="center"><div align="center"><b>Datos a Almacenar</div></h1>
	...
	<div align="center">
	<form action="insertartifer.php" method="post" name="medi">
...
echo "<tr><td><font color=blue size=4>ID_Tipo Tel.";
$con4="SELECT ID_TEL FROM tipotel";
...
echo "<option>", $fila4['ID_TEL']," </option>";
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO tifer(CLAVE_E3,ID_TEL1,TELEFONO) "."VALUES ('$combo1','$combo2','$tel')";
