...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Tipo Tel.</title></head>
    <body>
	...
	<div align="center">
	<form action="insertartipotel.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Tipo Teléfono:
	<td><input type="text" align="LEFT" name="id_tel" /></tr>
	<tr><td><font color=blue size=4>Tipo Teléfono:
	<td><input type="text" align="LEFT" name="nom_tel" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO tipotel(ID_TEL,NOM_TEL) "."VALUES ('$id_tel','$nom_tel')";
