...
echo "<tr><td><font color=blue size=4>ID_TPR";
$con4="SELECT ID_TPR FROM tipopar";
...
echo "<option>", $fila4['ID_TPR']," </option>";
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO tipoen(CLAVE_E5,ID_TPAR1) "."VALUES ('$combo1','$combo2')";
