...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Tipo de Enfermedad</title></head>
    <body>
	...
	<div align="center">
	<form action="insertartipoenf.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Tipo Enfermedad:
	<td><input type="text" align="LEFT" name="id_te" /></tr>
	<tr><td><font color=blue size=4>Tipo Enfermedad:
	<td><input type="text" align="LEFT" name="nom_te" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO tipoenf(ID_TE,NOM_TE) "."VALUES ('$id_te','$nom_te')";
