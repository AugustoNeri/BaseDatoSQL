...
?>
    <html>
    <head><title>Modificar Alergia</title></head>
    <body>
...
<th><font color=blue size=5>ID_Alergia</th>
<th><font color=blue size=5>Alergia</th>
...
while ($row=mysql_fetch_array($resultado)){
	echo "<tr><td align=center>".$row['ID_AL']."</td>";
	echo "<td align=center>".$row['NOM_AL']."</td>";
echo "<td align=center><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['ID_AL'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
if (isset ($cambiar)){
	...
	$sql = "SELECT * FROM ".$tabla." WHERE ID_AL=".$cambiar;
	//echo "sql=".$sql;
	...
	<p><font color=blue size=5>ID_Alergia:
	<input type="hidden" align="LEFT" name="id_al" value="<?php echo $registro['ID_AL'];?>" /><p>
	<p><font color=blue size=5>Alergia:
	<input type="text" align="LEFT" name="nom_al" value="<?php echo $registro['NOM_AL'];?>"/><p>
