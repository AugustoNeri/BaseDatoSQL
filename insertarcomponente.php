...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Componente</title></head>
    <body>
	...
	<div align="center">
	<form action="insertarcomponente.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Componente:
	<td><input type="text" align="LEFT" name="id_com" /></tr>
	<tr><td><font color=blue size=4>Componente:
	<td><input type="text" align="LEFT" name="nom_com" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO componente(ID_COM,NOM_COM) "."VALUES ('$id_com','$nom_com')";
