...
<h1><font color=red size=6 face="Courier"><div align="center"><div align="center"><b>Datos a Almacenar</div></h1>
	...
	<div align="center">
	<form action="insertarmeun.php" method="post" name="medi">
...
echo "<tr><td><font color=blue size=4>ID_Unidad";
$con4="SELECT ID_UN FROM UNIDAD";
...
echo "<option>", $fila4['ID_UN']," </option>";
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO MEUN(ID_MED5,ID_UN1) "."VALUES ('$combo1','$combo2')";
