...
<p> BUSCAR Enfermo-Medicamento</p>
<form action="buscar6.php" method="post" name="Buscar">
...
if($_POST){
	...
	echo "<br>";     
 	$sql =  "Select CLAVE_ENF,NOM_ENF,NOM_MED FROM enfermo join meen on enfermo.CLAVE_ENF=meen.CLAVE_E7 join medicamento on meen.ID_MED6=medicamento.ID_MED where CLAVE_ENF=".$id;
