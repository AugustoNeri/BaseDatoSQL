...
<form action="buscar9.php" method="post" name="Buscar">
...
if($_POST){
	...
	echo "<br>";     
 	$sql =  "Select CLAVE_ENF,NOM_ENF,NOM_MED,NOM_EMF FROM enfermo join meen on enfermo.CLAVE_ENF=meen.CLAVE_E7 join medicamento on meen.ID_MED6=medicamento.ID_MED join enfer on enfermo.CLAVE_ENF=enfer.CLAVE_E2 join enfermedad on enfer.ID_ENF2=enfermedad.ID_EMF where CLAVE_ENF=".$id;
