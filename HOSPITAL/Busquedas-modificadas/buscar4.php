...
<p> BUSCAR Enfermo-Diagnóstico</p>
<form action="buscar4.php" method="post" name="Buscar">
...
if($_POST){
	...
	echo "<br>";     
 	$sql =  "Select CLAVE_ENF,NOM_ENF,NOM_DIAG FROM enfermo join ENDIA on enfermo.CLAVE_ENF=endia.CLAVE_E6 join diagnostico on endia.ID_DIAG1=diagnostico.ID_DIAG where CLAVE_ENF=".$id;
