...
<h1><font color=red size=6 face="Courier"><div align="center"><div align="center"><b>Datos a Almacenar</div></h1>
	...
	<div align="center">
	<form action="insertarmeviad.php" method="post" name="medi">
...
echo "<tr><td><font color=blue size=4>ID_VIA";
$con4="SELECT ID_VIA FROM VIAADMON";
...
echo "<option>", $fila4['ID_VIA']," </option>";
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO MEVIAD(ID_MED2,ID_VIA1) "."VALUES ('$combo1','$combo2')";
