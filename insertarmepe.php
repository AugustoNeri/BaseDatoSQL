...
<h1><font color=red size=6 face="Courier"><div align="center"><div align="center"><b>Datos a Almacenar</div></h1>
	...
	<div align="center">
	<form action="insertarmepe.php" method="post" name="medi">
...
echo "<tr><td><font color=blue size=4>ID_Presentación";
$con4="SELECT ID_PRE FROM presentacion";
...
echo "<option>", $fila4['ID_PRE']," </option>";
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO MEPE(ID_MED1,ID_PRE1) "."VALUES ('$combo1','$combo2')";
