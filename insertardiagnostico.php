...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Diagnóstico</title></head>
    <body>
	...
	<div align="center">
	<form action="insertardiagnostico.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Diagnóstico:
	<td><input type="text" align="LEFT" name="id_diag" /></tr>
	<tr><td><font color=blue size=4>Diagnóstico:
	<td><input type="text" align="LEFT" name="nom_diag" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO diagnostico(ID_DIAG,NOM_DIAG) "."VALUES ('$id_diag','$nom_diag')";
