...
<h1><font color=red size=6 face="Courier"><div align="center"><div align="center"><b>Datos a Almacenar</div></h1>
	...
	<div align="center">
	<form action="insertarmeco.php" method="post" name="medi">
...
echo "<tr><td><font color=blue size=4>ID_Componente";
$con4="SELECT ID_COM FROM COMPONENTE";
...
echo "<option>", $fila4['ID_COM']," </option>";
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO MECO(ID_MED4,ID_COM1) "."VALUES ('$combo1','$combo2')";
