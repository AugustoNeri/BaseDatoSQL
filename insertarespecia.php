...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Especialidad</title></head>
    <body>
	...
	<div align="center">
	<form action="insertarespecia.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Especialidad:
	<td><input type="text" align="LEFT" name="id_ed" /></tr>
	<tr><td><font color=blue size=4>Eespecialidad:
	<td><input type="text" align="LEFT" name="nom_ed" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO especialidad (ID_ED,NOM_ED) "."VALUES ('$id_ed','$nom_ed')";
