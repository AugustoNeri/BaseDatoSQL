...
<h1><font color=red size=6 face="Courier"><div align="center"><div align="center"><b>Datos a Almacenar</div></h1>
	...
	<div align="center">
	<form action="insertarmela.php" method="post" name="medi">
...
echo "<tr><td><font color=blue size=4>ID_Laboratorio";
$con4="SELECT ID_LAB FROM LABORATORIO";
...
echo "<option>", $fila4['ID_LAB']," </option>";
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO MELA(ID_MED3,ID_LAB1) "."VALUES ('$combo1','$combo2')";
