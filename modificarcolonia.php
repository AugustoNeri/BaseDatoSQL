...
?>
    <html>
    <head><title>Modificar Colonia</title></head>
    <body>
...
<th><font color=blue size=5>ID_Colonia</th>
<th><font color=blue size=5>Colonia</th>
...
while ($row=mysql_fetch_array($resultado)){
	echo "<tr><td align=center>".$row['ID_COL']."</td>";
	echo "<td align=center>".$row['NOM_COL']."</td>";
echo "<td align=center><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['ID_COL'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
if (isset ($cambiar)){
	...
	$sql = "SELECT * FROM ".$tabla." WHERE ID_COL=".$cambiar;
	//echo "sql=".$sql;
