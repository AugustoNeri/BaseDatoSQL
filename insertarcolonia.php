...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Colonia</title></head>
    <body>
	...
	<div align="center">
	<form action="insertarcolonia.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Colonia:
	<td><input type="text" align="LEFT" name="id_col" /></tr>
	<tr><td><font color=blue size=4>Colonia:
	<td><input type="text" align="LEFT" name="nom_col" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO colonia(ID_COL,NOM_COL) "."VALUES ('$id_col','$nom_col')";
