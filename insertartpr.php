...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Tipo de Terapia</title></head>
    <body>
	...
	<div align="center">
	<form action="insertartpr.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Tipo Terapia:
	<td><input type="text" align="LEFT" name="id_tpr" /></tr>
	<tr><td><font color=blue size=4>Tipo de Terapia:
	<td><input type="text" align="LEFT" name="nom_tpr" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO tipopar(ID_TPR,NOM_TPR) "."VALUES ('$id_tpr','$nom_tpr')";
