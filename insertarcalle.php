...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Calle</title></head>
    <body>
	...
	<div align="center">
	<form action="insertarcalle.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Calle:
	<td><input type="text" align="LEFT" name="id_ca" /></tr>
	<tr><td><font color=blue size=4>Calle:
	<td><input type="text" align="LEFT" name="nom_ca" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO calle(ID_CA,NOM_CALLE) "."VALUES ('$id_ca','$nom_ca')";
