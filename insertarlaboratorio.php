...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Laboratorio</title></head>
    <body>
	...
	<div align="center">
	<form action="insertarlaboratorio.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Laboratorio:
	<td><input type="text" align="LEFT" name="id_lab" /></tr>
	<tr><td><font color=blue size=4>Laboratorio:
	<td><input type="text" align="LEFT" name="nom_lab" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO laboratorio(ID_LAB,NOM_LAB) "."VALUES ('$id_lab','$nom_lab')";
