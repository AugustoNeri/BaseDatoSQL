...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Horario</title></head>
    <body>
	...
	<div align="center">
	<form action="insertarhorario.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Horario:
	<td><input type="text" align="LEFT" name="id_ho" /></tr>
	<tr><td><font color=blue size=4>Horario:
	<td><input type="text" align="LEFT" name="nom_hob" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO horario (ID_HR,NOM_HR) "."VALUES ('$id_ho','$nom_ho')";
