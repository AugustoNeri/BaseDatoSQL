...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Presentación</title></head>
    <body>
	...
	<div align="center">
	<form action="insertarpresentacion.php" method="post" name="hobbie">
	<tr><td><font color=blue size=4>ID_Presentación:
	<td><input type="text" align="LEFT" name="id_pre" /></tr>
	<tr><td><font color=blue size=4>Presentación:
	<td><input type="text" align="LEFT" name="nom_pren" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO presentacion(ID_PRE,NOM_PREN) "."VALUES ('$id_pre','$nom_pren')";
