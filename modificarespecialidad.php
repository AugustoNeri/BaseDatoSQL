...
?>
    <html>
    <head><title>Modificar Especialidad</title></head>
    <body>
...
<th><font color=blue size=5>ID_Especialidad</th>
<th><font color=blue size=5>Especialidad</th>
...
while ($row=mysql_fetch_array($resultado)){
	echo "<tr><td align=center>".$row['ID_ED']."</td>";
	echo "<td align=center>".$row['NOM_ED']."</td>";
echo "<td align=center><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['ID_ED'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
if (isset ($cambiar)){
	...
	$sql = "SELECT * FROM ".$tabla." WHERE ID_ED=".$cambiar;
	//echo "sql=".$sql;
	...
	<p><font color=blue size=5>ID_Especialidad:
	<input type="hidden" align="LEFT" name="id_ed" value="<?php echo $registro['ID_ED'];?>" /><p>
	<p><font color=blue size=5>Especialidad:
	<input type="text" align="LEFT" name="nom_ed" value="<?php echo $registro['NOM_ED'];?>"/><p>
