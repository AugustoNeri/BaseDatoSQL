...
<h1><font color=red size=6 face="Courier"><div align="center"><div align="center"><b>Datos a Almacenar</div></h1>
	...
	<div align="center">
	<form action="insertaraleenf.php" method="post" name="medi">
...
echo "<tr><td><font color=blue size=4>ID_Alergia";
$con4="SELECT ID_AL FROM alergia";
...
echo "<option>", $fila4['ID_AL']," </option>";
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO ALEENF(CLAVE_E4,ID_ALE1) "."VALUES ('$combo1','$combo2')";
