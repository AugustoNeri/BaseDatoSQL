...
if (!$_POST ){ //evalua si se enviaron los datos del formulario
    ...
    <html>
    <head><title>Insertar Via Admon.</title></head>
    <body>
	...
	<tr><td><font color=blue size=4>ID_Via Admon:
	<td><input type="text" align="LEFT" name="id_via" /></tr>
	<tr><td><font color=blue size=4>Via de Administración:
	<td><input type="text" align="LEFT" name="nom_viad" /></tr>			
...
<?
 	...
 	echo "<br>";
 	$sql = "INSERT INTO viaadmon(ID_VIA,NOM_VIAD) "."VALUES ('$id_via','$nom_viad')";
