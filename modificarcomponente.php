...
?>
    <html>
    <head><title>Modificar Componente</title></head>
    <body>
...
<th><font color=blue size=5>ID_Componente</th>
<th><font color=blue size=5>Componente</th>
...
while ($row=mysql_fetch_array($resultado)){
	echo "<tr><td align=center>".$row['ID_COM']."</td>";
	echo "<td align=center>".$row['NOM_COM']."</td>";
echo "<td align=center><a href=".$_SERVER['PHP_SELF']."?cambiar=".$row['ID_COM'].">Editar</a></td></tr>";
}
?>
	</table>
	</div>
...
if (isset ($cambiar)){
	...
	$sql = "SELECT * FROM ".$tabla." WHERE ID_COM=".$cambiar;
	//echo "sql=".$sql;
	...
	<p><font color=blue size=5>ID_Componente:
	<input type="hidden" align="LEFT" name="id_com" value="<?php echo $registro['ID_COM'];?>" /><p>
	<p><font color=blue size=5>Componente:
	<input type="text" align="LEFT" name="nom_com" value="<?php echo $registro['NOM_COM'];?>"/><p>
